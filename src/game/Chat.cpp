...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    static ChatCommand reloadCommandTable[] =
    {
        ...
        { "gameobject_template",		 SEC_ADMINISTRATOR, true,  &ChatHandler::HandleGObjectReloadCommand,			     "", NULL },
...
//        { "auctions",                    SEC_ADMINISTRATOR, true,  &ChatHandler::HandleReloadAuctionsCommand,                "", NULL },
    ...
    static ChatCommand commandTable[] =
    {
        ...
        { "goto",         SEC_MODERATOR,      false, &ChatHandler::HandleGonameCommand,              "", NULL },
        ...
        { "gps",            SEC_PLAYER,      false, &ChatHandler::HandleGPSCommand,                 "", NULL },
